planets = {
    "Mercury": {
        ...
        "Mass": (3.285, 23),  # in (kg, exp) where kg * 10**exp
    ...
    "Venus": {
        ...
        "Mass": (4.867, 24),  # in (kg, exp) where kg * 10**exp
    ...
    "Earth": {
        ...
        "Mass": (5.972, 24),  # in (kg, exp) where kg * 10**exp
    ...
    "Mars": {
        ...
        "Mass": (6.39, 23),  # in (kg, exp) where kg * 10**exp
    ...
    "Jupiter": {
        ...
        "Mass": (1.898, 27),  # in (kg, exp) where kg * 10**exp
    ...
    "Saturn": {
        ...
        "Mass": (5.683, 26),  # in (kg, exp) where kg * 10**exp
    ...
    "Uranus": {
        ...
        "Mass": (8.681, 25),  # in (kg, exp) where kg * 10**exp
    ...
    "Neptune": {
        ...
        "Mass": (1.024, 26),  # in (kg, exp) where kg * 10**exp
